...
public class JwtAuthInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        String nickname = jwtProvider.getPrincipal(accessToken);
        validatePayload(nickname);

        long userId = authService.getUserIdByNickname(nickname);
    ...
    private void validatePayload(String nickname) {
        if (nickname == null) {
